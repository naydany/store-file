...
class Game:
    def __init__(self, root):
        ...
        self.canvas.pack()
        self.canvas.create_rectangle(0, 600, 1236, 700, fill="black", tags="wall")
        self.canvas.pack()
    ...
    def create_obstacle(self):
        x1 = self.scroll_offset + 900
        x2 = x1 + random.randint(50, 150)
        y1 = random.randint(150, 400)
        y2 = y1 + random.randint(20, 60)
        return self.canvas.create_rectangle(x1, y1, x2, y2, fill="black", tags="wall")
